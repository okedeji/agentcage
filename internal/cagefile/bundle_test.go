...
func TestPackToFile_ProducesBundle(t *testing.T) {
	...
	manifest, err := PackToFile(agentDir, "0.1.0", outPath)
...
func TestPackAndUnpack_RoundTrip(t *testing.T) {
	...
	_, err := PackToFile(agentDir, "0.1.0", bundlePath)
	require.NoError(t, err)
...
func TestPack_NoCagefile(t *testing.T) {
	...
	_, err := PackToFile(dir, "0.1.0", outPath)
	require.Error(t, err)
...
func TestUnpack_MissingManifest(t *testing.T) {
	...
	_, err := PackToFile(dir, "0.1.0", bundlePath)
	require.NoError(t, err)
...
func TestPack_StaticRuntime(t *testing.T) {
	...
	manifest, err := PackToFile(dir, "0.1.0", outPath)
	require.NoError(t, err)
...
func TestPack_FilesHash_ChangesWithContent(t *testing.T) {
	...
	m1, err := PackToFile(dir, "0.1.0", out1)
	require.NoError(t, err)
	...
	m2, err := PackToFile(dir, "0.1.0", out2)
	require.NoError(t, err)
