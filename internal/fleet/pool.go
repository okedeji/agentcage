...
// TotalCageSlots returns the sum of cage slots across every host.
// Used to size the cage worker's activity concurrency cap; allowing
// more activities than the fleet can host serves no one.
