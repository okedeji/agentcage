-- +migrate Up
CREATE TYPE assessment_status AS ENUM ('discovery', 'awaiting_plan_approval', 'exploitation', 'validation', 'enrichment', 'report_generation', 'pending_review', 'approved', 'rejected', 'unreviewed', 'plan_unapproved', 'failed');
