...
func newSecretsCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: `Manage named secrets in ~/.agentcage so a value is provided once and reused.
...
the process table.`,
		Example: `  agentcage secrets set openai_key < key.txt
  agentcage secrets ls
  agentcage secrets rm openai_key`,
	}
